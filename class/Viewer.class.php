    ...
    public function getPrintedView()
    {
        if (count($this->globals) == 0) {
            ...
            foreach ($this->globals as $key => $value) {
                ...
                echo '<td><a href="http://services.librairielabourse.fr/reports/product?date=' . $value['date'] . '&magasin=' . $value['magasin'] . '&rea=REASSORTI&type=LIVRE"><button class="btn">Réassort</button></a></td>';
